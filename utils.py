...
def result_in_txt_plnecp(file, cover_tree):
    filepath = os.path.join('./Results/plne/Spd_Inst_Rid_Final2_500-1000', "result_"+os.path.basename(file))
    if not os.path.exists('./Results/plne/Spd_Inst_Rid_Final2_500-1000'):
        os.makedirs('./Results/plne/Spd_Inst_Rid_Final2_500-1000')
