...
def result_in_txt_plnecp(file, cover_tree):
    filepath = os.path.join('./Results/plnecp/Spd_Inst_Rid_Final2_0-500', "result_"+os.path.basename(file))
...
def result_in_txt_plnecpm(file, cover_tree):
    filepath = os.path.join('./Results/plnecpm/Spd_Inst_Rid_Final2_0-500', "result_"+os.path.basename(file))
...
def result_in_txt_heuristiques(file, cover_tree):
    filepath = os.path.join('./Results/heuristiques/color_weight/Spd_Inst_Rid_Final2_0-500', "result_" + os.path.basename(file))
